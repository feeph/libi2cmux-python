...
class TCA9548A(MuxBurstHandler):
    """
    ...
    def __init__(self, i2c_bus: busio.I2C, i2c_adr: int, tca_adr: int = 0x70, tca_cid: int = 0, timeout_ms: int | None = 500):
        ...
        if 0 <= tca_cid <= 7:
            ...
            raise ValueError("TCA9548A channel id must be in range 0 ≤ x ≤ 7")
...
class PCA9548A(TCA9548A):
    """
    8-channel 2.3- to 5.5-V I2C/SMBus switch with reset & voltage translation

    This model has been superseded by the TCA9548A.
    """
